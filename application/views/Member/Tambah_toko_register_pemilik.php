    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                <center>
                    <div class="mb-2">
                        <h1 style="color: white">Daftar Pemilik Toko</h1>
                    </div>
                </center>
                <div class="login-form">
                    <?php echo $this->session->flashdata('message'); ?>
                    <form action="<?php echo base_url() ?>Member/Member_register_pemilik" method="POST">
                        ...
                        <div class="mb-2">
                            <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" name="btn_daftar">Register</button>
                        </div>
                        <div class="register-link m-t-15 text-center">
                            <p><a href="<?php echo base_url() ?>Beranda_member"> Kembali ke halaman utama</a></p>
                        </div>
                    </form>
                </div>
            </div>
